...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="bodies.css">
    </head>
    <body id="page-top">
        <nav class="navbar navbar-expand-lg bg-secondary fixed-top" id="mainNav">
            <div class="container"><a class="navbar-brand js-scroll-trigger" href="#page-top">Ferretería ITLA</a>
                <button class="navbar-toggler navbar-toggler-right font-weight-bold bg-primary text-white rounded" type="button" data-toggle="collapse" data-target="#navbarResponsive" aria-controls="navbarResponsive" aria-expanded="false" aria-label="Toggle navigation">Menu <i class="fas fa-bars"></i></button>
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
					<li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="Services.php">Services</a>
                        </li>
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                ...
                <!-- Masthead Heading-->
                <h1 class="masthead-heading mb-0">Oferta Del Día</h1>
                <!-- Icon Divider-->
                ...
                <p class="pre-wrap masthead-subheading font-weight-light mb-0">
				  <?php  
				      $texto = file_get_contents("data/oferta.txt");
					  print($texto);
				  ?>
				</p>
            </div>
        ...
        <section class="page-section" id="contact">
            <div class="container">
                ...
                <?php
                 include 'page/form_contact.php';
                 include 'page/procesa_form.php';
                ?>
            </div>
        </section>
